import excludeSpecificTypes, {ALL_TYPES, IAllTypes} from '../excludeSpecificTypes';
...
describe('excludeSpecificTypes 메서드 테스트', () => {
  ...
  it('Returns an array without String and Boolean type.', () => {
    ...
    const exceptString = excludeSpecificTypes(stringAndBoolean) as IAllTypes[];
  ...
  it('Returns an empty array [].', () => {
    const exceptAll = excludeSpecificTypes(ALL_TYPES.map(t => t.type)) as IAllTypes[];
